# Elasticsearch Helm Chart 安装部署
helm install --name elasticsearch --version 1.30.0 -f values.yaml --namespace log stable/elasticsearch

helm upgrade elasticsearch --version 1.30.0 -f values.yaml --namespace log stable/elasticsearch
...
### values修改地方：
1.  values.cluster.config 加入
    http.cors.enabled: true
    http.cors.allow-origin: "*"
    
# 镜像推送到腾讯云仓库

docker tag harbor.shixhlocal.com/library/dubbo-admin:0.2.0

docker login -u 100011147988 -p Harbor12345 ccr.ccs.tencentyun.com/sxhharbor

docker pull docker.elastic.co/elasticsearch/elasticsearch-oss:6.8.2
docker tag harbor.shixhlocal.com/library/dubbo-admin:0.2.0 ccr.ccs.tencentyun.com/sxhharbor/dubbo-admin:0.2.0
docker push ccr.ccs.tencentyun.com/sxhharbor/dubbo-admin:0.2.0


docker login -u	gaowei@1547228692479258 -p babyck528520~~ https://registry.cn-beijing.aliyuncs.com


docker pull registry.cn-beijing.aliyuncs.com/sxhharbor/es-provider:154

docker tag registry.cn-beijing.aliyuncs.com/sxhharbor/es-provider:154 ccr.ccs.tencentyun.com/sxhharbor/es-provider:154

docker push ccr.ccs.tencentyun.com/sxhharbor/es-provider:154

docker rmi -f ccr.ccs.tencentyun.com/sxhharbor/es-provider:154
...
docker tag k8s.gcr.io/defaultbackend-amd64:1.5 ccr.ccs.tencentyun.com/sxhharbor/defaultbackend-amd64:1.5
